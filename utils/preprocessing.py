...
if __name__ == '__main__':
    ...
    t1_list = sorted(glob.glob(
        '/home/ubuntu/Project/datasets/BraTS2021_TrainingData/*/*t1.*'))
    t2_list = sorted(glob.glob(
        '/home/ubuntu/Project/datasets/BraTS2021_TrainingData/*/*t2.*'))
    t1ce_list = sorted(glob.glob(
        '/home/ubuntu/Project/datasets/BraTS2021_TrainingData/*/*t1ce.*'))
    flair_list = sorted(glob.glob(
        '/home/ubuntu/Project/datasets/BraTS2021_TrainingData/*/*flair.*'))
    gt_list = sorted(glob.glob(
        '/home/ubuntu/Project/datasets/BraTS2021_TrainingData/*/*seg.*'))

    data_len = len(gt_list) 
    train_len = int(data_len * 0.8)
    test_len = data_len - train_len
    
    train_path = '../data/BraTS2021/train/'
    test_path = '../data/BraTS2021/test/'
    ...
    for i,(t1_path, t2_path, t1ce_path, flair_path, gt_path) in enumerate(zip(t1_list,t2_list,t1ce_list,flair_list,gt_list)):
        ...
        gt_data[gt_data == 4] = 3 #label 3 is missing in BraTS 2020 and 2021
